#!/usr/bin/env python3
"""migrate-context-to-project.py — 消费仓一次性迁移：旧项目级文档 → docs/PRODUCT.md

框架把项目级文档统一命名为 docs/PRODUCT.md（与 PRODUCT-STATE.md / PRODUCT-RULES.md
三兄弟对齐）。历史上这个文件用过两个旧名：
