...
| P0-6 | /pmai-skill-improve skill 雏形 + 反馈归档约定（skill-feedback/）| [完成] | 34b1d4d |
...
**为什么一起**：F-1（消化 484 行 PM 反馈）是 P0-6（/pmai-skill-improve skill 雏形）的天然第一案例——边消化边把"PM 写反馈 → AI 转 skill 改动"流程沉淀成 skill。
