...
> 活跃文档只保留当前能指导使用和维护的内容。旧设计稿已从 `docs/设计/` 删除；历史依据看 git history、`CHANGELOG.md` 和 `docs/归档/`。
...
| `pmai doctor --check` 看什么 | [`../README.md#开发者自检入口`](../README.md#开发者自检入口) |
| 怎么起一个新业务项目 | [`../README.md#快速开始`](../README.md#快速开始) |
| 怎么接已有代码仓 | [`../README.md#初始化新业务项目`](../README.md#初始化新业务项目) 里的 `/pmai-init-project`，它会自动进入已有代码接入分支 |
...
| 目录 | 说明 |
|---|---|
| [`归档/完成/`](./归档/完成/) | 已落地或历史完成的设计文档 |
| [`归档/废弃/`](./归档/废弃/) | 被否决、废弃或仅作历史参考的文档 |

## 顶层真相源

| 文件 | 说明 |
|---|---|
| [`../PRODUCT.md`](../PRODUCT.md) | 产品定位和取舍标准 |
| [`../README.md`](../README.md) | 用户可读安装与使用说明 |
