...
#   T2: 白名单文件被允许（PROJECT/DESIGN/PRODUCT-RULES/ROADMAP/prd/CONTEXT）
#   T3: 错位文件被拦下（exit 1）
...
test_whitelist_passes() {
  start_test "T2: 白名单文件（PROJECT/DESIGN/PRODUCT-RULES/ROADMAP/prd/CONTEXT）被允许"
  local tmp; tmp=$(mktemp -d)
  for f in PROJECT.md DESIGN.md PRODUCT-RULES.md ROADMAP.md prd.md CONTEXT.md; do
