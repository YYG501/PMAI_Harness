...
IMPL_TMPL="$REPO_ROOT/skills/implementation-design/templates/implementation-design.md.tmpl"
PLAN_TMPL="$REPO_ROOT/skills/task-plan/templates/task-plan.md.tmpl"
